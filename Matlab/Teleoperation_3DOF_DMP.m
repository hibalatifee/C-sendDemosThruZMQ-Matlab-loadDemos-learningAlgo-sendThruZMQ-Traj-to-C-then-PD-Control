...
load Position3D_Trial1.mat Position3D_Trial1;
load Position3D_Trial2.mat Position3D_Trial2;
load Position3D_Trial3.mat Position3D_Trial3;
...
Traj
% figure;
% plot3(Traj(1,:),Traj(2,:),Traj(3,:),'Color',[0,0.9,0.9]);
% hold on;
% 
