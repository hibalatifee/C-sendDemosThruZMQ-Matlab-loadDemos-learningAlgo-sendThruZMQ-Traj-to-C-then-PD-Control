...
ofstream fileActualPosition("actualPosition.txt");
ofstream fileActualForce("Force.txt");
//ofstream d("debug.txt");
//---------------------------------------------------------------
#define MASTER_DEVICE_NAME  "Omni"
#define SLAVE_DEVICE_NAME  "slave"

#define LIMIT_FORCE	1		//For premium, 5. For Omni, should be 2.5 or 3
#define K_simul		0.01
#define slv_damping	0.1
#define SCALE		1 
